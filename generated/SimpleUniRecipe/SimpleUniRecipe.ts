...
export class SimpleUniRecipe__bakeResult {
  value0: BigInt;
  value1: BigInt;
...
export class SimpleUniRecipe extends ethereum.SmartContract {
  static bind(address: Address): SimpleUniRecipe {
    return new SimpleUniRecipe("SimpleUniRecipe", address);
  }
  ...
  bake(
    ...
    return new SimpleUniRecipe__bakeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_bake(
    ...
    _maxInput: BigInt,
    _mintAmount: BigInt
  ): ethereum.CallResult<SimpleUniRecipe__bakeResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SimpleUniRecipe__bakeResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getPriceEth(_basket: Address, _amount: BigInt): BigInt {
    let result = super.call(
      "getPriceEth",
      "getPriceEth(address,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(_basket),
        ethereum.Value.fromUnsignedBigInt(_amount)
      ]
...
export class GetPriceEthCall extends ethereum.Call {
  get inputs(): GetPriceEthCall__Inputs {
    return new GetPriceEthCall__Inputs(this);
  }

  get outputs(): GetPriceEthCall__Outputs {
    return new GetPriceEthCall__Outputs(this);
  }
}

export class GetPriceEthCall__Inputs {
  _call: GetPriceEthCall;

  constructor(call: GetPriceEthCall) {
    this._call = call;
  }
...
export class GetPriceEthCall__Outputs {
  _call: GetPriceEthCall;
