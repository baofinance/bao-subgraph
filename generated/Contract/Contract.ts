...
export class Contract__vote_user_slopesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Contract__points_weightResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__points_sumResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  vote_user_slopes(
    arg0: Address,
    arg1: Address
  ): Contract__vote_user_slopesResult {
    let result = super.call(
      "vote_user_slopes",
    ...
    return new Contract__vote_user_slopesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_vote_user_slopes(
    arg0: Address,
    arg1: Address
  ): ethereum.CallResult<Contract__vote_user_slopesResult> {
    let result = super.tryCall(
      "vote_user_slopes",
      "vote_user_slopes(address,address):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(arg0), ethereum.Value.fromAddress(arg1)]
    ...
    return ethereum.CallResult.fromValue(
      new Contract__vote_user_slopesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  points_weight(arg0: Address, arg1: BigInt): Contract__points_weightResult {
    let result = super.call(
      "points_weight",
    ...
    return new Contract__points_weightResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_points_weight(
    arg0: Address,
    arg1: BigInt
  ): ethereum.CallResult<Contract__points_weightResult> {
    let result = super.tryCall(
      "points_weight",
      "points_weight(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__points_weightResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  points_sum(arg0: BigInt, arg1: BigInt): Contract__points_sumResult {
    let result = super.call(
      "points_sum",
    ...
    return new Contract__points_sumResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_points_sum(
    arg0: BigInt,
    arg1: BigInt
  ): ethereum.CallResult<Contract__points_sumResult> {
    let result = super.tryCall(
      "points_sum",
      "points_sum(int128,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__points_sumResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
