...
export class veBAO__lockedResult {
  value0: BigInt;
  value1: BigInt;
...
export class veBAO__point_historyResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class veBAO__user_point_historyResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class veBAO extends ethereum.SmartContract {
  static bind(address: Address): veBAO {
    return new veBAO("veBAO", address);
  }
  ...
  locked(arg0: Address): veBAO__lockedResult {
    let result = super.call("locked", "locked(address):(int128,uint256)", [
      ethereum.Value.fromAddress(arg0)
    ]);

    return new veBAO__lockedResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_locked(arg0: Address): ethereum.CallResult<veBAO__lockedResult> {
    ...
    return ethereum.CallResult.fromValue(
      new veBAO__lockedResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  point_history(arg0: BigInt): veBAO__point_historyResult {
    let result = super.call(
      "point_history",
    ...
    return new veBAO__point_historyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_point_history(
    arg0: BigInt
  ): ethereum.CallResult<veBAO__point_historyResult> {
    let result = super.tryCall(
      "point_history",
      "point_history(uint256):(int128,int128,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(arg0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new veBAO__point_historyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  user_point_history(
    arg0: Address,
    arg1: BigInt
  ): veBAO__user_point_historyResult {
    let result = super.call(
      "user_point_history",
    ...
    return new veBAO__user_point_historyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_user_point_history(
    arg0: Address,
    arg1: BigInt
  ): ethereum.CallResult<veBAO__user_point_historyResult> {
    let result = super.tryCall(
      "user_point_history",
      "user_point_history(address,uint256):(int128,int128,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new veBAO__user_point_historyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  try_future_distr_contract(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "future_distr_contract",
      "future_distr_contract():(address)",
      []
  ...
  distr_contract(): Address {
    let result = super.call("distr_contract", "distr_contract():(address)", []);

    return result[0].toAddress();
  }

  try_distr_contract(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "distr_contract",
      "distr_contract():(address)",
      []
...
export class Commit_distr_contractCall extends ethereum.Call {
  get inputs(): Commit_distr_contractCall__Inputs {
    return new Commit_distr_contractCall__Inputs(this);
  }

  get outputs(): Commit_distr_contractCall__Outputs {
    return new Commit_distr_contractCall__Outputs(this);
  }
}

export class Commit_distr_contractCall__Inputs {
  _call: Commit_distr_contractCall;

  constructor(call: Commit_distr_contractCall) {
    this._call = call;
  }
...
export class Commit_distr_contractCall__Outputs {
  _call: Commit_distr_contractCall;
...
export class Apply_distr_contractCall extends ethereum.Call {
  get inputs(): Apply_distr_contractCall__Inputs {
    return new Apply_distr_contractCall__Inputs(this);
  }

  get outputs(): Apply_distr_contractCall__Outputs {
    return new Apply_distr_contractCall__Outputs(this);
  }
}

export class Apply_distr_contractCall__Inputs {
  _call: Apply_distr_contractCall;

  constructor(call: Apply_distr_contractCall) {
    this._call = call;
  }
}

export class Apply_distr_contractCall__Outputs {
  _call: Apply_distr_contractCall;
