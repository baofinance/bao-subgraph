...
export class NewProtocolSeizeShare extends ethereum.Event {
  get params(): NewProtocolSeizeShare__Params {
    return new NewProtocolSeizeShare__Params(this);
  }
}

export class NewProtocolSeizeShare__Params {
  _event: NewProtocolSeizeShare;

  constructor(event: NewProtocolSeizeShare) {
    this._event = event;
  }

  get oldProtocolSeizeShareMantissa(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }

  get newProtocolSeizeShareMantissa(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }
}
...
export class bdbaoUSD__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class bdbaoUSD extends ethereum.SmartContract {
  static bind(address: Address): bdbaoUSD {
    return new bdbaoUSD("bdbaoUSD", address);
  }
  ...
  _setProtocolSeizeShare(newProtocolSeizeShareMantissa: BigInt): BigInt {
    let result = super.call(
  ...
  getAccountSnapshot(account: Address): bdbaoUSD__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new bdbaoUSD__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<bdbaoUSD__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new bdbaoUSD__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  mint(mintAmount: BigInt, enterMarket: boolean): BigInt {
    let result = super.call("mint", "mint(uint256,bool):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(mintAmount),
      ethereum.Value.fromBoolean(enterMarket)
    ]);
  ...
  try_mint(
    ...
    let result = super.tryCall("mint", "mint(uint256,bool):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(mintAmount),
      ethereum.Value.fromBoolean(enterMarket)
    ]);
    if (result.reverted) {
...
export class _setProtocolSeizeShareCall extends ethereum.Call {
  get inputs(): _setProtocolSeizeShareCall__Inputs {
    return new _setProtocolSeizeShareCall__Inputs(this);
  }

  get outputs(): _setProtocolSeizeShareCall__Outputs {
    return new _setProtocolSeizeShareCall__Outputs(this);
  }
}

export class _setProtocolSeizeShareCall__Inputs {
  _call: _setProtocolSeizeShareCall;

  constructor(call: _setProtocolSeizeShareCall) {
    this._call = call;
  }
...
export class _setProtocolSeizeShareCall__Outputs {
  _call: _setProtocolSeizeShareCall;
